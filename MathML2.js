	...
	*/
	...
	DesktopInit: function (mathMLUrl, latexUrl) {
		...
		var loadMathJax = function () {
			...
			if (D2LMathML2.ReadyState) {
				return;
			}

			D2LMathML2.ReadyState = 'loading';
			...
			//mathJaxScript.defer = 'defer';
			mathJaxScript.onload = function () {
				D2LMathML2.ReadyState = 'ready';
			};
			mathJaxScript.src = D2LMathML2.IsLatex ? latexUrl : mathMLUrl;
